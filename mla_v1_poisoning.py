...
parser.add_argument('--model', type=str, default='simplehgnn', choices=['hgnn', 'hypergcn', 'hgnnP','AllSetTransformer','hnhn','unigat','unigcn','unigin','unisage'], help='hypergraph NN model to attack')
...
if __name__ == '__main__':
    ...
    # H_adv.detach()
    # X_adv.detach()
    train_model(args, poisoned_model, H_adv.detach().to(device), X_adv.detach().to(device), y)
    ...
    acc_orig, acc_adv, acc_drop = classification_drop_pois(model, poisoned_model, H, X, H_adv, X_adv, y)
...
#  python mla_v1_poisoning.py --seed 8 --epsilon 3.0 --ptb_rate 0.2 --num_epochs 200 --dataset co-citeseer --eta_H 0.001 --eta_X 0.001
# python mla_v1_poisoning.py --seed 7 --epsilon 2.0 --ptb_rate 0.2 --num_epochs 200 --dataset coauth_cora --eta_H 0.001 --eta_X 0.001